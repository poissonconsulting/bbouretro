...
#'
#' @details See the \code{vignette("Methods", package = "bbouretro")} for
#'   description of the equations used. Users can plot the distribution of
#'   simulated \eqn{lambda} values using `bbr_plot_lambda_distributions()`
#'   function as well as estimated values using the `bbr_plot_lambda()`
#'   function.
#'
