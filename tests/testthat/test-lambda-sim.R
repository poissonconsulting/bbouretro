...
test_that("pop a works", {
  withr::with_seed(10, {
    ...
    expect_snapshot_data(output$RawValues, "bbr_lambda_sim_pop_a_raw_values")
    expect_snapshot_data(output$Summary, "bbr_lambda_sim_pop_a_summary")
  })
})
...
test_that("pop b works", {
  withr::with_seed(10, {
    ...
    expect_type(output, "list")
    expect_snapshot_data(output$RawValues, "bbr_lambda_sim_pop_b_raw_values")
    expect_snapshot_data(output$Summary, "bbr_lambda_sim_pop_b_summary")
  })
})
...
test_that("pop c works", {
  withr::with_seed(10, {
    ...
    expect_type(output, "list")
    expect_snapshot_data(output$RawValues, "bbr_lambda_sim_pop_c_raw_values")
    expect_snapshot_data(output$Summary, "bbr_lambda_sim_pop_c_summary")
  })
})
...
test_that("test data works", {
  withr::with_seed(10, {
    ...
    expect_snapshot_data(output$RawValues, "bbr_lambda_sim_raw_values")
    expect_snapshot_data(output$Summary, "bbr_lambda_sim_summary")
  })
})
...
test_that("NA instead in dataset work", {
  withr::with_seed(10, {
    ...
    expect_type(output, "list")
    expect_snapshot_data(output$RawValues, "bbr_lambda_sim_na_test_raw")
    expect_snapshot_data(output$Summary, "bbr_lambda_sim_na_test_sum")
  })
})
