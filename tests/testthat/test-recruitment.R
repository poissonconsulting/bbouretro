...
test_that("pop a works", {
  withr::with_seed(10, {
    ...
    expect_snapshot_data(output, "bbr_km_survival_a_bin")
    ...
    expect_s3_class(output, "data.frame")
    expect_snapshot_data(output, "bbr_km_survival_a_boot") 
  })
})
...
test_that("pop b works", {
  withr::with_seed(10, {
    ...
    expect_s3_class(output, "data.frame")
    expect_snapshot_data(output, "bbr_km_survival_b_bin")
    ...
    expect_s3_class(output, "data.frame")
    expect_snapshot_data(output, "bbr_km_survival_b_boot")
  })
})
...
test_that("pop c works", {
  withr::with_seed(10, {
    ...
    expect_s3_class(output, "data.frame")
    expect_snapshot_data(output, "bbr_km_survival_c_bin")
    ...
    expect_s3_class(output, "data.frame")
    expect_snapshot_data(output, "bbr_km_survival_c_boot")
  })
})
...
test_that("pFemales and sexratio matches what was set", {
  ...
  expect_snapshot_data(output, "bbr_km_survival_c_0")
})
