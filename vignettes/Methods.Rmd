...
where $X \cdot sex_ratio$ estimates the number of female calves $(n_{jf})$ per adult female. 
...
For `bbr_lambda_simulate()` function uses the basic Hatter-Bergerud method [@hatter_moose_1991].
